...
export function SocialLogin({ returnTo: initialReturnTo }: SocialLoginProps) {
  ...
  const personaOptions: Array<{
    ...
    {
      id: 'admin',
      name: 'Linh Quản Trị Viên',
      description: 'Quản trị viên nền tảng, điều phối thẩm định và ngân sách quỹ',
      roleTag: 'ADMIN',
    },
  ];
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="mt-1 text-center text-[10px] text-ink-muted">
            ℹ️ Chưa kết nối Auth Server BE (Nút Google mô phỏng đăng nhập bằng tài khoản mẫu).
          </div>
        </div>
