    ...
    <div className="rounded-card border border-sage bg-surface-card p-6 sm:p-8 max-w-md w-full mx-auto shadow-sm">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="w-full min-h-[44px] flex items-center justify-center gap-3 px-4 py-2.5 rounded-control border border-sage font-medium text-ink bg-white hover:bg-surface-canvas active:scale-[0.99] transition-all shadow-xs text-sm"
        >
        ...
        <button
          ...
          className="w-full min-h-[44px] flex items-center justify-center gap-3 px-4 py-2.5 rounded-control border border-sage font-medium text-ink bg-white hover:bg-surface-canvas active:scale-[0.99] transition-all shadow-xs text-sm"
        >
          <svg className="w-5 h-5 shrink-0 text-[#1877F2]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        {/* Notice if clicked */}
        {notice && (
          <div className="p-3 rounded-control bg-status-pending-bg text-status-pending text-xs border border-status-pending/30 animate-fadeIn leading-relaxed">
            {notice}
          </div>
        )}
        ...
        <Link
          ...
          className="w-full min-h-[44px] flex items-center justify-center gap-2 px-5 py-2.5 rounded-control font-semibold text-white bg-forest hover:bg-forest-hover transition-colors shadow-sm text-sm"
        >
      ...
      <div className="mt-6 pt-4 border-t border-sage/40 text-center text-xs text-ink-muted leading-relaxed">
        {t('auth.privacyNote')}
      </div>
    </div>
  );
